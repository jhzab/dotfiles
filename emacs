...
(setq package-list '(ensime magit flyspell flycheck neotree avy ace-window scala-mode2 git-gutter monokai-theme anzu flx-ido swiper smart-mode-line ample-theme projectile smex ido-ubiquitous haskell-mode intero flatui-theme))
